...
function AddPost() {
    ...
    const handleClick = async (e)=>{
        e.preventDefault()
        const x =  await  axios.post('https://elsever-backend.herokuapp.com/addpost',{ PostName:PostName,PostPhotoUrl:PostPhotoUrl,PostPlacer:PostPlacer,PostAbout:PostAbout,PostFullAbout:PostFullAbout })
